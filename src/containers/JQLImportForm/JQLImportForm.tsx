...
export const JQLImportContainer = ({ open, onClose }: { open: boolean; onClose: () => void }) => {
    ...
    const [getJQLTickets, { data: tickets, isLoading: isFetchingTickets }] = useGetJQLTicketsMutation();
    const [importTicket, { isLoading: isImporting }] = useImportTicketMutation();
    ...
    return (
        ...
        >
            ...
            <Box sx={{ 
                ...
                {!isFetchingTickets && tickets?.data?.map((ticket) => (
                    <Card 
                        key={ticket.id} 
                        variant="outlined" 
                        sx={{ 
                    ...
                    >
                        ...
                        <Button 
                            size="small" 
                            variant="contained" 
                            onClick={() => void handleImport(ticket.jira_key)}
                ...
                {!isFetchingTickets && tickets?.data && tickets.data.length === 0 && (

...
import {
  DESIGNATIONS,
  VALIDATION_REGEX,
} from "@pages/SignupComplete/SignupComplete.config";
...
export const Profile = () => {
  ...
  const validateForm = () => {
    ...
    } else if (formData.phone && !VALIDATION_REGEX.phone.test(formData.phone)) {
  ...
  return (
    <>
      <Stack direction="row" alignItems="center" justifyContent="space-between">
        ...
        <Box>
          {!editStatus ? (
            <Button onClick={handleEdit} color="inherit">
              <Edit />
            </Button>
          ) : (
      ...
      <Snackbar
        ...
        message={
          isUpdatingUser ? "Updating User Profile" : "User Profile Updated"
        }
      />
    </>
  );
